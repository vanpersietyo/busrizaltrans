 ...
 * @property M_trtype           $M_trtype
 * @property M_transcode        $M_transcode
 * @property M_trtype_module    $M_trtype_module
 * @property M_trtype_class     $M_trtype_class
 * @property M_trtype_part      $M_trtype_part
 * @property M_trtype_spec      $M_trtype_spec
 * @property M_item             $M_item
 * @property M_item_category    $M_item_category
 * @property M_item_unit        $M_tr$M_item_unittype_spec
 * @property M_item_group       $M_item_group
 * @property M_price_master     $M_price_master
 * @property M_price_list       $M_price_list
 * @property M_approval_set     $M_approval_set
 * @property M_approval_set_dtl $M_approval_set_dtl
 * @property M_prtranshdr_approval         $M_prtranshdr_approval
 * @property M_prtransdtl       $M_prtransdtl
 * @property M_prtranshdr       $M_prtranshdr
 * @property M_supplier         $M_supplier
 * @property M_delivery_note_hdr            $M_delivery_note_hdr
 * @property M_delivery_note_dtl            $M_delivery_note_dtl
 * @property M_delivery_note_hdr_approval           $M_delivery_note_hdr_approval
 * @property M_pstranshdr           $M_pstranshdr
 * @property M_pstransdtl           $M_pstransdtl
 * @property M_pstranshdr_approval  $M_pstranshdr_approval
 *
 * @property Conversion         $conversion
 * @property Unirest            $unirest
 * @property Breadcrumbs        $breadcrumbs
 * @property Telegram_bot       $telegram_bot
 * @property BotApi             $botapi
 * @property My_Pusher          $my_pusher
 * @property Role               $role
 * @property My_Pusher          $My_Pusher
 */
class CI_Model
