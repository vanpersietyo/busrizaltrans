                        ...
                        <div class="box-body pad">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="autofocus" type="text" name="nama" class="form-control pull-right"
                                    <?php if (isset($nama_kota_awal)!=null) echo 'value="'.$nama_kota_awal.'"';?>>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="harga" class="form-control pull-right money" id="money" onfocus="$(this).select()"
                                    <?php if (isset($keterangan_kota_awal)!=null or isset($keterangan_kota_awal) !=0 ){echo 'value="'.$keterangan_kota_awal.'"';} else { echo 'value="0"';}?>>
                            </div>
                    ...
                    <div class="box-body table-responsive">
                        <table id="example3" class="table table-bordered table-hover">
                            ...
                            foreach ($list_kota as $list) {?>
                                <tr>
                                    <td><?=$list->kode_kota_awal?></td>
                                    <td><?=$list->nama_kota_awal?></td>
                                    <td><?=$list->keterangan_kota_awal?></td>
                                    <td><a href="<?=site_url('admin/edit_harga_request/'.$list->kode_kota_awal)?>" type="button" class="btn btn-sm btn-warning" >E</a>
                                        <a href="<?=site_url('admin/harga_request.do/'.$list->kode_kota_awal)?>" type="button" class="btn btn-sm btn-danger" >X</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                        </table>
