...
<!-- notif -->
<?=$this->session->flashdata('list_fasilitas');?>
<!-- notif -->
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="box">
                ...
                <form class="form-horizontal" method="post" action="<?=site_url('admin/add_fasilitas.do')?>">
                ...
                <div class="box-body with-border">
                        <div class="box-body pad">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input autofocus="autofocus" type="text" name="nama_fasilitas" class="form-control pull-right"
